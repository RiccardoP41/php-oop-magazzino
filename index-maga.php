...
echo  "</br>" ."Spesa per volume: " .$fumetto1->prezzoVolume();
...
echo  "</br>" ."Spesa per volume: " .$fumetto2->prezzoVolume();
...
echo  "</br>" ."Spesa per volume: " .$estero1->prezzoVolume();
...
echo  "</br>" ."Spesa per volume: " .$premium1->prezzoVolume();
